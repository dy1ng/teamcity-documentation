...
|[Google Chrome](https://www.google.com/chrome/)|109.0.5414.74|
|[ChromeDriver](https://chromedriver.chromium.org/)|109.0.5414.74|
|[Docker](https://www.docker.com/)|20.10.22|
|[Docker CLI](https://docs.docker.com/engine/reference/commandline/cli/)|20.10.22|
|[Docker Compose](https://docs.docker.com/compose/)|1.29.2|
|[AWS CLI](https://aws.amazon.com/cli/)|2.9.13|
|[kubectl](https://kubernetes.io/docs/tasks/tools/#kubectl)|v1.26.0|
|[Azure CLI](https://docs.microsoft.com/en-us/cli/azure/)|2.44.1|
|[Google Cloud SDK](https://cloud.google.com/sdk)|413.0.0|
...
|[Python Virtualenv](https://virtualenv.pypa.io/en/latest/)|20.17.1|
|[Python Pipenv](https://pipenv.pypa.io/en/latest/)|2022.12.19|
|[Python Poetry](https://python-poetry.org/)|1.3.2)|
|[rustup](https://rustup.rs/)|1.25.1|
|[Cargo](https://doc.rust-lang.org/cargo/)|1.66.1|
|[rustc](https://doc.rust-lang.org/rustc/what-is-rustc.html)|1.66.1|
